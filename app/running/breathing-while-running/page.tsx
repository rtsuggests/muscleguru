...
export const metadata: Metadata = {
  title: "How to Breathe While Running India",
  description: "Nose vs mouth breathing, rhythmic 3:2 pattern, side stitch prevention, and breathing in pollution.",
};
    ...
    <>
      <div style={{background:"var(--color-bg)",borderBottom:"1px solid var(--color-border)",padding:"0.6rem 1rem"}}>
        <div style={{maxWidth:860,margin:"0 auto",fontSize:"0.82rem",color:"var(--color-muted)",display:"flex",gap:"0.4rem",flexWrap:"wrap"}}>
          ...
          <span>›</span>
          <span style={{color:"var(--color-dark)",fontWeight:500}}>How to Breathe While Running India</span>
        </div>
      </div>
      <div style={{maxWidth:860,margin:"0 auto",padding:"2.5rem 1rem 5rem"}}>
        ...
        <h1 style={{fontSize:"clamp(1.6rem,4vw,2.5rem)",lineHeight:1.2,marginBottom:"1rem"}}>How to Breathe While Running India</h1>
        <div style={{background:"var(--color-brand-light)",border:"1.5px solid #86efac",borderRadius:"0.875rem",padding:"1.125rem 1.375rem",marginBottom:"1.5rem"}}>
          ...
          <p style={{margin:0,fontSize:"0.975rem",color:"var(--color-dark)",lineHeight:1.65}}>Breathe through both nose and mouth simultaneously. Use 3:2 rhythm (inhale 3 steps, exhale 2 steps). If you cannot speak in short sentences, you are running too fast.</p>
        </div>
        <div className="seo-content">
          <p>Nose vs mouth breathing, rhythmic 3:2 pattern, side stitch prevention, and breathing in pollution.</p>
