...
export const metadata: Metadata = {
  ...
  description: "Interval training, tempo runs, cadence improvement, hill sprints, and a 6-week speed plan.",
};
  ...
  return (
    <>
      ...
      <div style={{maxWidth:860,margin:"0 auto",padding:"2.5rem 1rem 5rem"}}>
        ...
        <h1 style={{fontSize:"clamp(1.6rem,4vw,2.5rem)",lineHeight:1.2,marginBottom:"1rem"}}>How to Run Faster — Speed Training India</h1>
        <div style={{background:"var(--color-brand-light)",border:"1.5px solid #86efac",borderRadius:"0.875rem",padding:"1.125rem 1.375rem",marginBottom:"1.5rem"}}>
          ...
          <p style={{margin:0,fontSize:"0.975rem",color:"var(--color-dark)",lineHeight:1.65}}>Add 1-2 quality sessions per week. Intervals target VO2 max, tempo runs raise lactate threshold. Increase cadence to 170-180 steps per minute.</p>
        </div>
        <div className="seo-content">
          <p>Interval training, tempo runs, cadence improvement, hill sprints, and a 6-week speed plan.</p>
