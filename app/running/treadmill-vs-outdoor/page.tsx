...
export const metadata: Metadata = {
  title: "Treadmill vs Outdoor Running India",
  description: "Evidence-based comparison for Indian runners. Monsoon and pollution protocols, the 1% incline rule.",
};
    ...
    <>
      <div style={{background:"var(--color-bg)",borderBottom:"1px solid var(--color-border)",padding:"0.6rem 1rem"}}>
        <div style={{maxWidth:860,margin:"0 auto",fontSize:"0.82rem",color:"var(--color-muted)",display:"flex",gap:"0.4rem",flexWrap:"wrap"}}>
          ...
          <span>›</span>
          <span style={{color:"var(--color-dark)",fontWeight:500}}>Treadmill vs Outdoor Running India</span>
        </div>
      </div>
      <div style={{maxWidth:860,margin:"0 auto",padding:"2.5rem 1rem 5rem"}}>
        ...
        <h1 style={{fontSize:"clamp(1.6rem,4vw,2.5rem)",lineHeight:1.2,marginBottom:"1rem"}}>Treadmill vs Outdoor Running India</h1>
        <div style={{background:"var(--color-brand-light)",border:"1.5px solid #86efac",borderRadius:"0.875rem",padding:"1.125rem 1.375rem",marginBottom:"1.5rem"}}>
          ...
          <p style={{margin:0,fontSize:"0.975rem",color:"var(--color-dark)",lineHeight:1.65}}>Use 1% incline on treadmill to match outdoor effort. Move indoors during AQI 150+. Use outdoor running for race preparation.</p>
        </div>
        <div className="seo-content">
          <p>Evidence-based comparison for Indian runners. Monsoon and pollution protocols, the 1% incline rule.</p>
