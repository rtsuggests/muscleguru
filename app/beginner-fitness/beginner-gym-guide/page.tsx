...
export const metadata: Metadata = {
  ...
  description: "Everything a beginner needs to know about starting at the gym.",
};
...
export default function Page() {
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "2.5rem 1rem 5rem" }}>
      ...
      <h1 style={{ fontSize: "clamp(1.6rem, 4vw, 2.5rem)", lineHeight: 1.2, margin: "1rem 0" }}>Beginner Gym Guide India</h1>
      <div className="seo-content">
        <h2>First Steps</h2>
        <p>Learn the 5 basic compound movements: squat, deadlift, bench press, overhead press, and row. Start with lighter weights to master form. Track every workout to ensure progressive overload.</p>
